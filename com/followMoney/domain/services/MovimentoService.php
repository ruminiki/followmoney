...
include_once("com/followMoney/dao/MovimentoProgramadoDao.php");
...
class MovimentoService
{
	...
	public function findMovimentosProgramados($usuario){
    	return MovimentoProgramadoDao::findMovimentosProgramados($usuario);
    }
	
	public function cancelarAgendamento($movimentoProgramado){
    	return MovimentoProgramadoDao::cancelarAgendamento($movimentoProgramado);
    }
	
	public function agendarLancamentoProgramado($movimentoProgramado){
    	return MovimentoProgramadoDao::agendarLancamentoProgramado($movimentoProgramado);
    }
